// Water Sort 5 Colors / 5 Layers - Standalone Vanilla JS
(function () {
  'use strict';

  // 7 colors, each with 5 layers = 35 total layers
  const COLORS = [
    { id: 'c0', name: 'Crimson', gradient: 'linear-gradient(180deg, #f87171 0%, #dc2626 100%)' },
    { id: 'c1', name: 'Azure', gradient: 'linear-gradient(180deg, #60a5fa 0%, #2563eb 100%)' },
    { id: 'c2', name: 'Jade', gradient: 'linear-gradient(180deg, #34d399 0%, #059669 100%)' },
    { id: 'c3', name: 'Amber', gradient: 'linear-gradient(180deg, #fbbf24 0%, #d97706 100%)' },
    { id: 'c4', name: 'Orchid', gradient: 'linear-gradient(180deg, #c084fc 0%, #7e22ce 100%)' },
    { id: 'c5', name: 'Tangerine', gradient: 'linear-gradient(180deg, #fb923c 0%, #ea580c 100%)' },
    { id: 'c6', name: 'Cyan', gradient: 'linear-gradient(180deg, #22d3ee 0%, #0891b2 100%)' },
  ];

  const TUBE_CAPACITY = 5; // 5 layers deep
  const NUM_FILLED = 7;    // 7 filled tubes * 5 = 35 layers
  const NUM_TUBES = 9;     // 7 filled + 2 empty
  ...
  function generateSolvablePuzzle() {
    ...
    for (let i = 0; i < NUM_FILLED; i++) {
      state.push(items.slice(i * 5, (i + 1) * 5));
    }
